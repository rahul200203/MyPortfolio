...
if($_POST['email']){
$subject=" Rahul-Portfolio Query Form ";
$subject=$subject;
$to = 'rspictures2019@gmail.com';		
/*Enter ur Subject */
$msg = '<html>
<head>
<title> Rahul-Portfolio Query Form</title>
...
<h3 style="text-align:center">Rahul-Portfolio Query Form</h3>
...
$headers .= 'From: Rahul-Portfolio Query Form <rspictures2019@gmail.com>' . "\r\n";		
